...
<body class="home">
    ...
    <section class="hero bg-image" data-image-src="images/mm.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-red">
                <h1>Sweets and Dessert Delights </h1>
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="dishes.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/62908867a48e4'.$rows['image'].'" alt="Restaurant logo"> </a>
																</div>
